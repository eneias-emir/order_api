...
class OrdersApiStack(Stack):
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        create_order_integration = integrations.HttpLambdaIntegration("CreateOrderIntegration", create_order_lambda)
        read_order_integration = integrations.HttpLambdaIntegration("ReadOrderIntegration", read_order_lambda)
        update_order_integration = integrations.HttpLambdaIntegration("UpdateOrderIntegration", update_order_lambda)
        delete_order_integration = integrations.HttpLambdaIntegration("DeleteOrderIntegration", delete_order_lambda)
